...
class Question(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            "title", "category_id", name="questions_title_category_unique"
        ),
    )
    ...
    # Soft delete. Set by the admin console instead of a real DELETE, because
    # user_answers cascades from questions and a hard delete would erase the
    # answer rows of every past attempt that used this question.
